...
export class InitialMigrations1742854786792 implements MigrationInterface {
    name = 'InitialMigrations1742854786792'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('super_admin', 'admin', 'teacher', 'manager', 'other')`);
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "email" character varying NOT NULL, "phone" character varying NOT NULL, "password" character varying NOT NULL, "role" "public"."users_role_enum" NOT NULL DEFAULT 'admin', "salary" integer, "commissionPercentage" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "centerId" integer, "organizationId" integer, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_a000cca60bcf04454e727699490" UNIQUE ("phone"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."students_status_enum" AS ENUM('yangi', 'oqimagan', 'oqiyapti', 'oqishni toxtatgan')`);
        await queryRunner.query(`CREATE TABLE "students" ("id" SERIAL NOT NULL, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "phone" character varying NOT NULL, "birthDate" date NOT NULL, "status" "public"."students_status_enum" NOT NULL DEFAULT 'yangi', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "centerId" integer, "groupId" integer, CONSTRAINT "UQ_317b86154bca256bdf5432f134c" UNIQUE ("phone"), CONSTRAINT "PK_7d7f07271ad4ce999880713f05e" PRIMARY KEY ("id"))`);
